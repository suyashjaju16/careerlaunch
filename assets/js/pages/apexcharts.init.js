var options = {
    ...
    options = ((chart = new ApexCharts(document.querySelector("#column_chart_datalabel"), options)).render(), {
        ...
        xaxis: {
            categories: ["I can define strengths and challenges related to career goals.", "I understand how strengths and challenges can shape my career paths and goals", "I sometimes examine strengths and challenges to find learning experiences needed to move toward my career goals", "I consistently examine strengths and challenges to design a plan to find learning experiences needed to move toward my career goals", "None of the Above (I am just beginning to learn about this skill)"]
        },
        legend: {
            offsetY: 5
        }
