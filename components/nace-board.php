...
<div class="card upcard border-2">
    <div class="row w-100 align-items-center">
        ...
        <div class="col-sm-8" style="margin:auto">
            <div class="competency-grid mt-4 mb-4" style="grid-column-gap : 8px;margin-left:-16px">
                <?php
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12 px-0">
                    <?php include("components/guageCharts.php"); ?>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <button class="accordion-button collapsed btn-up" type="button" data-bs-toggle="collapse"
                        ...
                        <div class="row align-items-center p-0 w-100">
                            ...
                            <div class="col-sm-8 p-3" style="margin-top:20px;margin:auto">
                                <div class="competency-grid mt-1" style="line-height:0;">
                                    <div
                                ...
                                <div class="mt-3" style="width:100%;margin:auto">
                                    ...
                                    <div
                                        style="margin-top:-38px;margin-left:<?= $comp_data['communication_results']['Average'] - 2 ?>%!important;width:fit-content">
                                        <center>
                                            <div class="progress-value" style="font-size:20px;background-color:#00A4FE">
                        ...
                        <div class="row align-items-center p-0 w-100">
                            ...
                            <div class="col-sm-8 p-3" style="margin-top:20px;margin:auto">
                                ...
                                <div class="mt-3" style="width:100%;margin:auto">
                                    ...
                                    <div
                                        style="margin-top:-38px;margin-left:<?= $comp_data['teamwork_results']['Average'] - 2 ?>%!important;width:fit-content">
                                        <center>
                                            <div class="progress-value" style="font-size:20px;background-color:#E06B60">
                        ...
                        <div class="row align-items-center p-0 w-100">
                            ...
                            <div class="col-sm-8 p-3" style="margin-top:20px;margin:auto">
                                ...
                                <div class="mt-3" style="width:100%;margin:auto">
                                    ...
                                    <div
                                        style="margin-top:-38px;margin-left:<?= $comp_data['self_development_results']['Average'] - 2 ?>%!important;width:fit-content">
                                        <center>
                                            <div class="progress-value bg-warning" style="font-size:20px">
                        ...
                        <div class="row align-items-center p-0 w-100">
                            ...
                            <div class="col-sm-8 p-3" style="margin-top:20px;margin:auto">
                                ...
                                <div class="mt-3" style="width:100%;margin:auto">
                                    ...
                                    <div
                                        style="margin-top:-38px;margin-left:<?= $comp_data['professionalism_results']['Average'] - 2 ?>%!important;width:fit-content">
                                        <center>
                                            <div class="progress-value" style="font-size:20px;background-color:#609866">
                        ...
                        <div class="row align-items-center p-0 w-100">
                            ...
                            <div class="col-sm-8 p-3" style="margin-top:20px;margin:auto">
                                ...
                                <div class="mt-3" style="width:100%;margin:auto">
                                    ...
                                    <div
                                        style="margin-top:-38px;margin-left:<?= $comp_data['leadership_results']['Average'] - 2 ?>%!important;width:fit-content">
                                        <center>
                                            <div class="progress-value" style="font-size:20px;background-color:#796258">
                        ...
                        <div class="row align-items-center p-0 w-100">
                            ...
                            <div class="col-sm-8 p-3" style="margin-top:20px;margin:auto">
                                ...
                                <div class="mt-3" style="width:100%;margin:auto">
                                    ...
                                    <div
                                        style="margin-top:-38px;margin-left:<?= $comp_data['critical_thinking_results']['Average'] - 2 ?>%!important;width:fit-content">
                                        <center>
                                            <div class="progress-value" style="font-size:20px;background-color:#705181">
                        ...
                        <div class="row align-items-center p-0 w-100">
                            ...
                            <div class="col-sm-8 p-3" style="margin-top:20px;margin:auto">
                                ...
                                <div class="mt-3" style="width:100%;margin:auto">
                                    ...
                                    <div
                                        style="margin-top:-38px;margin-left:<?= $comp_data['technology_results']['Average'] - 2 ?>%!important;width:fit-content">
                                        <center>
                                            <div class="progress-value" style="font-size:20px;background-color:#3C4B6C">
                        ...
                        <div class="row align-items-center p-0 w-100">
                            ...
                            <div class="col-sm-8 p-3" style="margin-top:20px;margin:auto">
                                ...
                                <div class="mt-3" style="width:100%;margin:auto">
                                    ...
                                    <div
                                        style="margin-top:-38px;margin-left:<?= $comp_data['equity_results']['Average'] - 2 ?>%!important;width:fit-content">
                                        <center>
                                            <div class="progress-value" style="font-size:20px;background-color:#AD3131">
